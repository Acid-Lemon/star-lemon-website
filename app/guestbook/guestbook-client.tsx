    ...
    return (
        <div className="flex-1 flex flex-col gap-8 pt-8 pb-16 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center">
                <h1 className="text-3xl font-serif text-gray-800 mb-3">留言板</h1>
            ...
            <section className="w-full">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <Card className="border-0 bg-gradient-to-br from-white to-blue-50/50 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                    ...
                    <Card className="border-0 bg-gradient-to-br from-white to-green-50/50 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                        <CardContent className="p-5">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="text-sm text-gray-500">已显示</div>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                    
                    <Card className="border-0 bg-gradient-to-br from-white to-purple-50/50 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                        <CardContent className="p-5">
                            <div className="flex items-center gap-4">
            ...
            {/* 留言区域 */}
            <section className="w-full">
                <Card className="border-0 bg-gradient-to-r from-orange-50 via-white to-yellow-50 shadow-lg overflow-hidden">
                    <CardContent className="p-6 md:p-8">
                        <div className="flex items-center justify-center gap-3 mb-5">
                            ...
                            <div>
                                <h2 className="text-lg font-serif text-gray-800">写下你想说的话</h2>
                                <p className="text-sm text-gray-500">分享你的想法、建议或问候</p>
                            </div>
                        </div>
                        {session ? (
                            ...
                            <div className="text-center">
                                <p className="text-gray-500 mb-4">登录后即可留言</p>
                                <Link 
            ...
            <section className="w-full">
                <div className="text-center mb-6">
                    <h2 className="text-2xl font-serif text-gray-800 mb-2">留言墙</h2>
                    <p className="text-gray-500 text-sm">共 {messages.length} 条留言</p>
                </div>
                ...
                {messages.length === 0 ? (
                    <Card className="border-0 bg-gradient-to-br from-gray-50 to-gray-100/50">
                        <CardContent className="py-20 text-center">
                            ...
                            <p className="text-gray-500 text-lg mb-2">还没有留言</p>
                            <p className="text-gray-400 text-sm">快来写下第一条吧！</p>
                        </CardContent>
                    </Card>
                ) : (
