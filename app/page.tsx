    ...
    return (
        <div className="flex-1 flex flex-col gap-16 w-full max-w-7xl mx-auto px-4 pb-20 pt-8">
            ...
            <section className="w-full">
                <Card
                    className="border-0 bg-gradient-to-r from-orange-50 via-white to-blue-50 dark:from-orange-950/20 dark:via-gray-900 dark:to-blue-950/20 shadow-lg overflow-hidden">
                    <CardContent className="p-0">
                        <div className="flex flex-col md:flex-row items-center">
                            <div className="flex-1 p-8 md:p-12 text-center md:text-left">
                                <div
                                    className="inline-flex items-center px-3 bg-orange-100/60 dark:bg-orange-900/30 rounded-full text-sm text-orange-600 dark:text-orange-400 mb-4">
                                    <span className="w-2 h-2 rounded-full bg-orange-500 animate-pulse"/>
                                    欢迎来到我们的小站
                                </div>
                                <h1 className="text-3xl md:text-5xl font-display font-bold text-gray-800 dark:text-gray-100 mb-4">
                                    {siteTitle}
                                </h1>
                                <HeroDescription siteDescription={siteDescription}/>
                            ...
                            <div className="flex-1 p-8 md:p-12 flex items-center justify-center relative">
                                <div className="relative">
                                    <div
                                        className="absolute -inset-8 bg-gradient-to-br from-orange-200/30 to-blue-200/30 dark:from-orange-800/20 dark:to-blue-800/20 rounded-full blur-3xl animate-blob"/>
                                    <div
                                        className="absolute -inset-12 bg-gradient-to-br from-blue-200/20 to-purple-200/20 dark:from-blue-800/10 dark:to-purple-800/10 rounded-full blur-3xl animate-blob animation-delay-2000"/>

                                    <div className="relative flex items-center gap-4">
                                        <div className="flex flex-col items-center">
                                            <div className="relative group">
                                                <div
                                                    className="absolute -inset-2 bg-gradient-to-r from-blue-400 to-cyan-300 rounded-full blur opacity-20 group-hover:opacity-40 transition duration-500"/>
                                                <Image
                                            ...
                                            <span
                                                className="text-base font-display font-bold text-gray-400 dark:text-gray-500 tracking-[0.3em] mt-2">STAR</span>
                                        </div>
                                        <RiLink/>
                                        <div className="flex flex-col items-center">
                                            <div className="relative group">
                                                <div
                                                    className="absolute -inset-2 bg-gradient-to-r from-yellow-400 to-orange-300 rounded-full blur opacity-20 group-hover:opacity-40 transition duration-500"/>
                                                <Image
                                                    className="relative rounded-full border-4 border-white dark:border-gray-700 shadow-lg object-cover w-20 h-20 md:w-28 md:h-28"
                                                    width={112}
                                                    height={112}
                                            ...
                                            <span
                                                className="text-base font-display font-bold text-gray-400 dark:text-gray-500 tracking-[0.3em] mt-2">LEMON</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            {quoteEnabled && (
                <section className="w-full max-w-4xl mx-auto">
                    <Card
                        className="border-0 bg-gradient-to-br from-white to-orange-50/30 dark:from-gray-900 dark:to-orange-950/10 shadow-lg hover:shadow-xl transition-shadow duration-500">
                        <CardContent className="p-8 md:p-12 text-center relative">
                            <div className="absolute top-6 left-8 text-gray-200 dark:text-gray-700 opacity-30">
                                <RiDoubleQuotesL className="w-12 h-12"/></div>
                            <div className="absolute bottom-2 right-8 text-gray-200 dark:text-gray-700 opacity-30">
                                <RiDoubleQuotesR className="w-12 h-12"/></div>

                            <div
                                className="text-gray-700 dark:text-gray-300 text-xl md:text-2xl font-serif leading-loose relative z-10 px-8 min-h-[4rem] flex items-center justify-center">
                                {quote.content}
                            </div>

                            <div
                                className="text-gray-400 dark:text-gray-500 text-sm font-mono mt-8 relative z-10 flex items-center justify-center gap-3">
                                <span
                                    className="w-8 h-px bg-gradient-to-r from-transparent to-gray-300 dark:to-gray-600"></span>
                                {quote.source || "未知"}
                                <span
                                    className="w-8 h-px bg-gradient-to-l from-transparent to-gray-300 dark:to-gray-600"></span>
                            </div>
                        </CardContent>
                    </Card>
                </section>
            ...
            <section className="w-full">
                ...
                {stats.posts === 0 && stats.users === 0 && stats.comments === 0 ? (
                    <div className="text-center py-12">
                        <div
                            className="w-20 h-20 mx-auto mb-4 rounded-full bg-orange-50 dark:bg-orange-950/30 flex items-center justify-center">
                    ...
                    {[
                        {
                            ...
                            title: '文章',
                            desc: '阅读技术文章',
                            bg: 'from-white to-blue-50/30 dark:from-gray-900 dark:to-blue-950/20',
                        ...
                        },
                        {
                            ...
                            title: '留言板',
                            desc: '与我们互动',
                            bg: 'from-white to-yellow-50/30 dark:from-gray-900 dark:to-yellow-950/20',
                        ...
                        },
                        {
                            ...
                            title: '关于',
                            desc: '了解我们',
                            bg: 'from-white to-green-50/30 dark:from-gray-900 dark:to-green-950/20',
                        ...
                        },
                        {
                            ...
                            title: '工具',
                            desc: '实用小工具',
                            bg: 'from-white to-purple-50/30 dark:from-gray-900 dark:to-purple-950/20',
                        ...
                        <Link key={item.href} href={item.href} className="group">
                            <Card
                                ...
                                <CardHeader className="text-center">
                                    ...
                                    <CardTitle
                                        className={`text-lg font-bold text-gray-800 dark:text-gray-100 ${item.hoverColor} transition-colors`}>
                                        {item.title}
                                    </CardTitle>
