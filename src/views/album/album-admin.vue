...
<template>
    <admin-view>
        <div class="w-full h-[95vh] flex flex-col items-center overflow-y-hidden bg-[#F8FAFD]">
            <el-tabs v-model="active_name" v-loading="loading" class="w-[95%]" @tab-change="get_folders">
