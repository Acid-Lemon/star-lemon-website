      ...
      <div class="flex flex-col items-center justify-center bg-[#F8FAFD]">
        <div
          ...
          <div class="w-full h-full flex flex-col items-center justify-center">
            ...
            <p class="text-[1.9vh] m-[2vh] font-['FZSX']">——『{{
                sentences?.from
              }}』{{ sentences?.from_who === null ? '未知' : sentences?.from_who }}</p>
          </div>
        </div>
        ...
        <div v-if="is_login"
          ...
          <div class="my-[3vh] flex flex-col justify-center md:w-[85%] w-[90%]">
            ...
            <div class="w-full flex flex-row justify-around md:justify-end">
              ...
              <el-button round style="width: 150px;height: 40px" type="primary" @click="publish_message">发布
              </el-button>
            </div>
            <div class="absolute bottom-[2vh] left-[16vh] w-[5vh] h-[5vh]">
              <el-popover :width="450" placement="top">
                <template #reference>
                  <img alt="表情" class="w-[5vh] h-[5vh] absolute top-[-20px]" src="/static/emoji/doge.png"/>
                </template>
        ...
        <div v-infinite-scroll="get_messages" :infinite-scroll-disabled="state"
          ...
          <div v-for="message in message_list" :key="message.id"
            ...
            <div :style="`background-color: ${message.background_color}`" class="md:w-[70%] w-[85%] shadow-md"
                 @click="console.log(message.background_color)">
              <div class="flex flex-row justify-between mt-[1vh] mx-[1vh]">
                <div class="flex flex-row items-center">
                  <el-avatar :src="message.user.avatar_url" style="width:5.4vh;height:5.4vh">{{ message.user.name }}
                  </el-avatar>
                ...
                <div v-if="this.user_info.id === message.user.id" class="flex flex-row items-center m-[20px]">
              ...
              <div class="m-[1vh] flex flex-row items-center">
                <div v-for="split_content in emoji_divide(message.content)" class="flex flex-row items-center">
                  ...
                  <el-image v-if="split_content.type==='emoji'" :src="'/static/emoji/' + split_content.words + '.png'"
