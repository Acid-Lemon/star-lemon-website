...
<template>
    <div class="w-full h-full">
        <div class="w-full h-[6vh] fixed top-0 left-0 p-[10px] z-[1000] flex flex-row items-center">
            <div class="flex flex-row items-center text-[#FFFFFF] font-['RGBZ']" @click="on_back">
            ...
            <el-scrollbar ref="el-scrollbar" ,bn, @scroll="handle_scroll">
                ...
                <div class="w-full flex flex-row items-start justify-center bg-[#F8FAFD]">
                    ...
                    <div class="w-[70vw] flex flex-col items-center justify-start">
                        <div
                            class="w-full bg-[#FFFFFF] shadow-md mt-[20px] text-[2vh] font-['SYST'] p-[40px] whitespace-pre-line">
                            {{ article.content }}
                        </div>
                    </div>
